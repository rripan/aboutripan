...
const projects = [
  {
    ...
    challenges:
      "Integrating multiple data sources (ServiceNow APIs, Excel, PDFs) into a cohesive pipeline while ensuring reliability through error handling and maintaining modularity for future enhancements.",
    outcome:
      "Significantly reduced manual reporting time, improved accuracy, and demonstrated how automation and tooling can drive efficiency and scalability in operational workflows.",
  },
  {
    ...
    period: "May 2025",
    description:
      "A full-stack personal portfolio website with AI-powered chatbot functionality for enhanced user interaction.",
    overview:
      "Developed a comprehensive personal portfolio website that showcases my work and skills. The project features a modern React frontend with a Flask backend, integrating Google Gemini API to provide an intelligent chatbot that can answer questions about my experience and projects.",
    features: [
    ...
    challenges:
      "Integrating the Gemini API required careful prompt engineering to ensure the chatbot provided accurate and relevant responses about my professional background.",
    outcome:
      "Created an engaging portfolio that stands out with its interactive AI features, improving visitor engagement and time spent on the site.",
  },
  {
    id: "ticket-resale",
    ...
    overview:
      "Initiated and collaborated on the development of a peer-to-peer ticket resale platform, designed to provide a secure and user-friendly marketplace for buying and selling event tickets.",
    features: [
    ...
    challenges:
      "Designing a database schema that could handle complex relationships between users, tickets, events, and transactions while maintaining data integrity and security.",
  ...
  },
  {
    ...
    overview:
      'Developed within a 24-hour hackathon, "Ready" is a study app prototype designed to help students manage test anxiety, improve exam preparation, and develop better time management skills.',
    features: [
    ...
    challenges:
      "Conducting rapid user research and synthesizing findings into actionable design decisions within the 24-hour hackathon timeframe.",
    outcome:
      "Created a validated prototype that addressed real pain points for students aged 18-23, incorporating research on study habits and behavioral patterns.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground mb-12">A detailed look at the projects I've built and contributed to.</p>
                ...
                <div className="bg-card border border-border rounded-lg p-6 md:p-8">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="text-xl md:text-2xl font-mono font-semibold text-foreground">{project.title}</h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="p-4 bg-secondary/50 rounded-lg border border-border/50">
                      <h4 className="font-mono text-sm text-primary uppercase tracking-wider mb-2">Challenge</h4>
                      <p className="text-sm text-muted-foreground">{project.challenges}</p>
                    </div>
                    <div className="p-4 bg-secondary/50 rounded-lg border border-border/50">
                      <h4 className="font-mono text-sm text-primary uppercase tracking-wider mb-2">Outcome</h4>
