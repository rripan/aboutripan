    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <h1 className="opacity-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <span className="text-4xl md:text-6xl lg:text-7xl font-mono font-bold text-foreground">
            Alex Chen
          </span>
        </h1>
        ...
        <div className="opacity-0 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <p className="mt-6 text-muted-foreground max-w-lg mx-auto text-sm md:text-base leading-relaxed">
            Building elegant solutions with clean code. Passionate about 
            creating performant web applications and developer tools.
          </p>
        </div>

        {/* Social Links */}
        <div className="opacity-0 animate-fade-in flex items-center justify-center gap-4 mt-8" style={{ animationDelay: '0.5s' }}>
          <a
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-0 animate-fade-in" style={{ animationDelay: '0.8s' }}>
